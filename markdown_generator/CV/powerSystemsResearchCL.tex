...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{National Renewable Energy Laboratory}{Concerning: Graduate Summer Intern –Learning-based Optimal Control for Improving Grid Resilience}
\date{\today}
...
NREL seems a natural fit for my skillset and curiosity, as a leader in energy system modeling, especially the energy transition. While I am currently unexperienced in power-system modeling, I have a strong mathematical background in optimization, with a solid understanding of networks and dynamical systems. I hope to get a chance to learn and contribute to the research at NREL.
