...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{National Renewable Energy Laboratory}{Concerning: Commercial Building Software Engineer}
\date{\today}
...
As I near the end of the PhD, I seek a full-time position to enrich my training via hands-on application, development and deployment of algorithms to problems at scale. In particular, I look to fuse my experiences as a software engineer and researcher to develop and deploy modeling and simulation algorithms in a team environment, with focus on reliability, maintainability, and performance.

NREL seems a natural fit for my skillset and curiosity. While I am currently unexperienced with the exact application area, I learn very quickly, and have a strong foundation upon which to grow.
